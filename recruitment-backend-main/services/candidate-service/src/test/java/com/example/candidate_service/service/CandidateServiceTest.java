...
class CandidateServiceTest {
    ...
    @Test
    // Test Case ID: TCCS001 - true branch for email existence lookup.
    @DisplayName("TCCS001 - existsByEmail() returns true when candidate exists")
    void tccs001_existsByEmail_whenCandidateExists_returnsTrue() {
    ...
    @Test
    // Test Case ID: TCCS002 - false branch for email existence lookup.
    @DisplayName("TCCS002 - existsByEmail() returns false when candidate does not exist")
    void tccs002_existsByEmail_whenCandidateMissing_returnsFalse() {
    ...
    @Test
    // Test Case ID: TCCS003 - success path for findByEmail.
    @DisplayName("TCCS003 - findByEmail() returns candidate when email exists")
    void tccs003_findByEmail_whenEmailExists_returnsCandidate() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS004 - fail path for findByEmail.
    @DisplayName("TCCS004 - findByEmail() throws when email is missing")
    void tccs004_findByEmail_whenEmailMissing_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS005 - CheckDB save state for direct saveCandidate.
    @DisplayName("TCCS005 - saveCandidate() saves and returns repository entity")
    void tccs005_saveCandidate_savesAndReturnsEntity() {
    ...
    @Test
    // Test Case ID: TCCS006 - repository read delegation for count.
    @DisplayName("TCCS006 - countCandidatesByJobPositionId() returns repository count")
    void tccs006_countCandidatesByJobPositionId_returnsCount() {
    ...
    @Test
    // Test Case ID: TCCS007 - department filter true branch with no jobs.
    @DisplayName("TCCS007 - getAllWithFilters() returns empty page when department has no jobs")
    void tccs007_getAllWithFilters_whenDepartmentHasNoJobs_returnsEmptyPage() {
    ...
    @Test
    // Test Case ID: TCCS008 - filter parsing and enrichment branch.
    @DisplayName("TCCS008 - getAllWithFilters() enriches job title and department when job data exists")
    void tccs008_getAllWithFilters_whenJobDataExists_enrichesRows() {
    ...
    @Test
    // Test Case ID: TCCS009 - token false branch skips enrichment.
    @DisplayName("TCCS009 - getAllWithFilters() skips enrichment when token is blank")
    void tccs009_getAllWithFilters_whenTokenBlank_skipsEnrichment() {
    ...
    @Test
    // Test Case ID: TCCS010 - success path for getById.
    @DisplayName("TCCS010 - getById() returns detail DTO when candidate exists")
    void tccs010_getById_whenFound_returnsDetail() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS011 - fail path for getById.
    @DisplayName("TCCS011 - getById() throws when candidate is missing")
    void tccs011_getById_whenMissing_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS012 - CheckDB create state with createdBy branch true.
    @DisplayName("TCCS012 - create() saves candidate with submitted status and createdBy")
    void tccs012_create_whenValid_savesExpectedState() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS013 - fail path for duplicate create.
    @DisplayName("TCCS013 - create() throws when candidate already applied to same job")
    void tccs013_create_whenDuplicate_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS014 - CheckDB update state for non-null fields.
    @DisplayName("TCCS014 - update() updates provided profile fields")
    void tccs014_update_whenFieldsProvided_updatesState() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS015 - null branch preserves existing update values.
    @DisplayName("TCCS015 - update() preserves existing state when DTO fields are null")
    void tccs015_update_whenFieldsNull_preservesState() throws IdInvalidException {
        ...
        assertEquals("Original", candidateService.update(15L, new UpdateCandidateDTO()).getName());
    }

    @Test
    // Test Case ID: TCCS016 - fail path for update missing candidate.
    @DisplayName("TCCS016 - update() throws when candidate is missing")
    void tccs016_update_whenMissing_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS017 - CheckDB delete interaction.
    @DisplayName("TCCS017 - delete() deletes existing candidate")
    void tccs017_delete_whenFound_deletesCandidate() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS018 - fail path for delete missing candidate.
    @DisplayName("TCCS018 - delete() throws when candidate is missing")
    void tccs018_delete_whenMissing_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS019 - batch read path.
    @DisplayName("TCCS019 - getByIds() returns detail DTOs for ids")
    void tccs019_getByIds_returnsDetails() {
    ...
    @Test
    // Test Case ID: TCCS020 - CheckDB create application with optional notes true branch.
    @DisplayName("TCCS020 - createCandidateFromApplication() saves application with notes")
    void tccs020_createCandidateFromApplication_whenNotesProvided_savesCandidate() throws Exception {
    ...
    @Test
    // Test Case ID: TCCS021 - optional notes false branch.
    @DisplayName("TCCS021 - createCandidateFromApplication() saves application without notes")
    void tccs021_createCandidateFromApplication_whenNotesNull_keepsNotesNull() throws Exception {
    ...
    @Test
    // Test Case ID: TCCS022 - duplicate application fail path.
    @DisplayName("TCCS022 - createCandidateFromApplication() throws for duplicate application")
    void tccs022_createCandidateFromApplication_whenDuplicate_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS023 - CheckDB rejected branch sets feedback.
    @DisplayName("TCCS023 - updateCandidateStatus() stores rejection reason for REJECTED")
    void tccs023_updateCandidateStatus_whenRejected_setsReason() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS024 - non-rejected branch does not set feedback.
    @DisplayName("TCCS024 - updateCandidateStatus() does not store reason for non-rejected status")
    void tccs024_updateCandidateStatus_whenNotRejected_doesNotSetReason() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS025 - invalid status fail path.
    @DisplayName("TCCS025 - updateCandidateStatus() throws when status value is invalid")
    void tccs025_updateCandidateStatus_whenInvalidStatus_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS026 - detail enrichment success path.
    @DisplayName("TCCS026 - getCandidateDetailById() enriches comments reviews job and schedules")
    void tccs026_getCandidateDetailById_whenDependenciesSucceed_enrichesDetail() throws Exception {
        ...
        assertNotNull(result.getJobPosition());
        assertEquals(1, result.getUpcomingSchedules().size());
    }

    @Test
    // Test Case ID: TCCS027 - review failure branch recovers with empty reviews.
    @DisplayName("TCCS027 - getCandidateDetailById() uses empty reviews when review service fails")
    void tccs027_getCandidateDetailById_whenReviewFails_recovers() throws Exception {
    ...
    @Test
    // Test Case ID: TCCS028 - department lookup success branch.
    @DisplayName("TCCS028 - getDepartmentIdByCandidateId() returns department id from job service")
    void tccs028_getDepartmentIdByCandidateId_whenFound_returnsDepartment() {
    ...
    @Test
    // Test Case ID: TCCS029 - department lookup false branch.
    @DisplayName("TCCS029 - getDepartmentIdByCandidateId() returns null when candidate or job is missing")
    void tccs029_getDepartmentIdByCandidateId_whenMissing_returnsNull() {
    ...
    @Test
    // Test Case ID: TCCS030 - interviewer candidate lookup empty branch.
    @DisplayName("TCCS030 - getCandidatesByInterviewer() returns empty list when no candidate ids")
    void tccs030_getCandidatesByInterviewer_whenNoIds_returnsEmptyList() {
    ...
    @Test
    // Test Case ID: TCCS031 - interviewer candidate lookup enrichment branch.
    @DisplayName("TCCS031 - getCandidatesByInterviewer() enriches job data when token exists")
    void tccs031_getCandidatesByInterviewer_whenJobDataExists_enrichesCandidates() {
    ...
    @Test
    // Test Case ID: TCCS032 - conversion success path using provided ids.
    @DisplayName("TCCS032 - convertCandidateToEmployee() creates employee when required ids are provided")
    void tccs032_convertCandidateToEmployee_whenIdsProvided_returnsBody() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS033 - conversion derives department from job service.
    @DisplayName("TCCS033 - convertCandidateToEmployee() derives department id when missing")
    void tccs033_convertCandidateToEmployee_whenDepartmentMissing_derivesFromJob() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS034 - conversion fail paths for required ids.
    @DisplayName("TCCS034 - convertCandidateToEmployee() throws when required ids cannot be resolved")
    void tccs034_convertCandidateToEmployee_whenRequiredIdsMissing_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS035 - conversion fail path from user service.
    @DisplayName("TCCS035 - convertCandidateToEmployee() throws when user service rejects creation")
    void tccs035_convertCandidateToEmployee_whenUserServiceFails_throwsException() {
    ...
    @Test
    // Test Case ID: TCCS036 - statistics without department filter.
    @DisplayName("TCCS036 - getCandidatesForStatistics() returns candidate statistics with department")
    void tccs036_getCandidatesForStatistics_withoutDepartmentFilter_returnsStats() {
    ...
    @Test
    // Test Case ID: TCCS037 - statistics department filter true branch.
    @DisplayName("TCCS037 - getCandidatesForStatistics() filters by department id")
    void tccs037_getCandidatesForStatistics_withDepartmentFilter_returnsOnlyMatchingDepartment() {
        Pageable pageable = PageRequest.of(0, 10000, Sort.by(Sort.Direction.DESC, "appliedDate"));
        when(candidateRepository.findByFilters(null, null, null, null, null, null, null, pageable))
    ...
    @Test
    // Test Case ID: TCCS038 - EXPECTED FAIL/Bug exposed: service currently accepts candidate with null email.
    @DisplayName("TCCS038 - EXPECTED FAIL - create() should reject candidate when email is null")
    void tccs038_create_whenEmailIsNull_shouldThrowAndNotSave() {
    ...
    @Test
    // Test Case ID: TCCS039 - EXPECTED FAIL/Bug exposed: service currently does not clear notes to null.
    @DisplayName("TCCS039 - EXPECTED FAIL - update() should allow clearing notes to null")
    void tccs039_update_whenNotesIsNull_shouldClearExistingNotes() throws IdInvalidException {
    ...
    @Test
    // Test Case ID: TCCS040 - DB failure path for direct saveCandidate.
    @DisplayName("TCCS040 - saveCandidate() propagates repository exception when DB save fails")
    void tccs040_saveCandidate_whenRepositoryThrows_shouldPropagateException() {
    ...
    @Test
    // Test Case ID: TCCS041 - repository read delegation for zero count.
    @DisplayName("TCCS041 - countCandidatesByJobPositionId() returns zero when job has no candidates")
    void tccs041_countCandidatesByJobPositionId_whenNoCandidate_returnsZero() {
    ...
    @Test
    // Test Case ID: TCCS042 - EXPECTED FAIL/Bug exposed: service currently does not block duplicate email update.
    @DisplayName("TCCS042 - EXPECTED FAIL - update() should reject email already used by another candidate")
    void tccs042_update_whenEmailBelongsToAnotherCandidate_shouldThrowAndNotSave() {
    ...
    @Test
    // Test Case ID: TCCS043 - EXPECTED FAIL/Bug exposed: service currently treats empty dateOfBirth as invalid format.
    @DisplayName("TCCS043 - EXPECTED FAIL - update() should clear dateOfBirth when request date is empty")
    void tccs043_update_whenDateOfBirthIsEmpty_shouldClearDateWithoutFormatError() {
    ...
    @Test
    // Test Case ID: TCCS044 - empty id list should return empty result.
    @DisplayName("TCCS044 - getByIds() returns empty list when ids are empty")
    void tccs044_getByIds_whenIdsEmpty_returnsEmptyList() {
    ...
    @Test
    // Test Case ID: TCCS045 - missing ids are ignored by repository result.
    @DisplayName("TCCS045 - getByIds() returns only existing candidates when some ids are missing")
    void tccs045_getByIds_whenSomeIdsMissing_returnsExistingCandidatesOnly() {
    ...
    @Test
    // Test Case ID: TCCS046 - business rule from application upload when CV is optional.
    @DisplayName("TCCS046 - createCandidateFromApplication() should allow missing cvUrl and save null resumeUrl")
    void tccs046_createCandidateFromApplication_whenCvUrlNull_shouldSaveCandidateWithNullResumeUrl() throws Exception {
    ...
    @Test
    // Test Case ID: TCCS047 - EXPECTED FAIL/Bug exposed: service currently does not return a clear validation exception for null status.
    @DisplayName("TCCS047 - EXPECTED FAIL - updateCandidateStatus() should reject null status")
    void tccs047_updateCandidateStatus_whenStatusNull_shouldThrowIllegalArgumentExceptionAndNotSave() {
    ...
    @Test
    // Test Case ID: TCCS048 - EXPECTED FAIL/Bug exposed: service currently saves even when status is unchanged.
    @DisplayName("TCCS048 - EXPECTED FAIL - updateCandidateStatus() should not save when new status equals current status")
    void tccs048_updateCandidateStatus_whenStatusIsUnchanged_shouldReturnCurrentStateWithoutSaving() throws IdInvalidException {
