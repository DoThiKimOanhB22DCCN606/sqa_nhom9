...
class NotificationServiceTest {
    ...
    @Test
    @DisplayName("TC-NS-019 - EXPECTED FAIL - Khong tao notification khi recipientId null")
    void tc_ns_019_createNotification_whenRecipientIdIsNull_shouldThrowExceptionAndNotSaveNotification() {
        // Test Case ID: TC-NS-019 - EXPECTED FAIL/Bug exposed: service currently accepts null recipientId.
    ...
    @Test
    @DisplayName("TC-NS-020 - EXPECTED FAIL - Khong mark all as read khi recipientId null")
    void tc_ns_020_markAllAsRead_whenRecipientIdIsNull_shouldThrowExceptionAndNotUpdateDatabase() {
        // Test Case ID: TC-NS-020 - EXPECTED FAIL/Bug exposed: service currently accepts null recipientId for markAllAsRead.
    ...
    @Test
    @DisplayName("TC-NS-021 - EXPECTED FAIL - Khong tao notification khi event khong co title")
    void tc_ns_021_processNotificationEvent_whenTitleIsNull_shouldThrowExceptionAndNotCreateNotifications() {
        // Test Case ID: TC-NS-021 - EXPECTED FAIL/Bug exposed: service currently accepts event with null title.
